...
export const metadata: Metadata = {
  ...
  description:
    "Enkel pris for somevideopost.com: €10/md. for studie-adgang med AI-opslag og direkte deling til sociale medier, og 99 kr. pr. præsentationsvideo — betal kun for de videoer, du bruger. Ingen binding.",
  keywords:
  ...
  openGraph: {
    ...
    description:
      "€10/md. for studie-adgang med AI-opslag og direkte deling, og 99 kr. pr. præsentationsvideo. Betal kun for det, du bruger. Ingen binding.",
    type: "website",
